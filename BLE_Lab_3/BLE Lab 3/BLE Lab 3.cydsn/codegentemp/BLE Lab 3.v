...
module BLE_v1_20_0 (
	...
	cy_clock_v1_0
		#(.id("53e81bdc-fe86-4fe1-af0b-3e29e5409d5a/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=true, Mode=1, OutputCurrent=0, Power=1, CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp, CY_INSTANCE_SHORT_NAME=Opamp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP3, INSTANCE_NAME=Opamp, )
...
module ADC_SAR_SEQ_P4_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("344eaca2-284b-4ab1-86c6-06322489019a/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("abbf7e51-e6aa-4a24-a525-15147d50b751"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fbe0e88e-3b27-4f34-a284-53f3e430e191"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
